...
const AdminAnalytics = () => {
  ...
  const metrics: Metric[] = [
    { title: "Total Revenue", value: formatPrice(data.metrics.total_revenue), change: "+12.5%", isPositive: true, icon: DollarSign },
    { title: "Total Orders", value: data.metrics.total_orders.toString(), change: "+8.2%", isPositive: true, icon: ShoppingCart },
    { title: "Average Order Value", value: formatPrice(data.metrics.average_order_value), change: "+4.3%", isPositive: true, icon: TrendingUp },
    { title: "Conversion Rate", value: `${data.metrics.conversion_rate}%`, change: "-0.5%", isPositive: false, icon: Users },
  ];
            ...
            <CardContent>
              <ResponsiveContainer width="100%" height={300}>
                <PieChart>
                  ...
                  >
                    {data.category_data.map((entry: CategoryData, index: number) => (
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-4">
                {data.top_products.map((product: TopProduct, index: number) => (
